...
for ndx = 1:length(handles.windows)
    ...
    data{ndx,2} = handles.windows{ndx}.transformation;
    data{ndx,3} = handles.windows{ndx}.primaryMonitor;
    data{ndx,4} = handles.windows{ndx}.monitor;
    data{ndx,5} = handles.windows{ndx}.fullScreen;
    data{ndx,6} = handles.windows{ndx}.left;
    data{ndx,7} = handles.windows{ndx}.bottom;
    data{ndx,8} = handles.windows{ndx}.width;
    data{ndx,9} = handles.windows{ndx}.height;
