function code = DMSDiscreetIntGraded2Towers_imaging
...
%specify probabilities
              % HARD           MEDIUM       EASY
vr.mazeProbs = [0.4/1         0.45/1       0.5/1;...  %a
                0.3/2         0.35/2       0.35/2;...  %b
                0.3/2         0.35/2       0.35/2;...  %c
                0.3/2         0.20/2       0.15/2;...  %d
                0.3/2         0.20/2       0.15/2;...  %f
                0.1/2            0/2          0/2;...     %g
                0.1/2            0/2          0/2   ];    %h
...
vr.whiteDots = find(currMazePattern == 1)';
vr.numWhite = sum(currMazePattern);
