function code = GradedBlockDelay2TowersContCrutch
% GradedBlockDelay2TowersContCrutch   Code for the ViRMEn experiment GradedBlockDelay2TowersContCrutch.
%   code = GradedBlockDelay2TowersContCrutch   Returns handles to the functions that ViRMEn
...
vr.mouseNum = 94;
vr.greyFac = 0/60; %goes from 0 to 1 to signify the amount of maze which is grey
vr.midOff = 5/6;
vr.numRewPer = 1;
