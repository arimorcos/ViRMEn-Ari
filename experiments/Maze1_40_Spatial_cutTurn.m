function code = Maze1_40_Spatial_cutTurn
% Maze1_40_Spatial_cutTurn   Code for the ViRMEn experiment Maze1_40_Spatial_cutTurn.
%   code = Maze1_40_Spatial_cutTurn   Returns handles to the functions that ViRMEn
...
vr.debugMode = true;
vr.mouseNum = 109;
vr.rewSize = 3; %num pulses per reward
