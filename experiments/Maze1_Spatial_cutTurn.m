function code = Maze1_Spatial_cutTurn
% Maze1_Spatial_cutTurn   Code for the ViRMEn experiment Maze1_Spatial_cutTurn.
%   code = Maze1_Spatial_cutTurn   Returns handles to the functions that ViRMEn
