function code = Maze2_4Cond_cutTurn
% Maze2_4Cond_cutTurn   Code for the ViRMEn experiment Maze2_4Cond_cutTurn.
%   code = Maze2_4Cond_cutTurn   Returns handles to the functions that ViRMEn
