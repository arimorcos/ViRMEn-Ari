function code = AMDMSMaze2WallsAdaptive
% AMDMSMaze2WallsAdaptive   Code for the ViRMEn experiment AMDMSMaze2WallsAdaptive.
%   code = AMDMSMaze2WallsAdaptive   Returns handles to the functions that ViRMEn
