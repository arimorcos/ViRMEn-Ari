...
vr.blackLeftNoTower = [beginBlack whiteRight dirTower backBlack];

vr.blackRightTower = [beginBlack whiteLeft backBlack blackRightTower];
vr.blackRightNoTower = [beginBlack whiteLeft dirTower backBlack];

vr.whiteLeftTower = [beginWhite whiteLeft backWhite whiteLeftTower];
vr.whiteLeftNoTower = [beginWhite whiteLeft dirTower backWhite];

vr.whiteRightTower = [beginWhite whiteRight backWhite whiteRightTower];
vr.whiteRightNoTower = [beginWhite whiteRight dirTower backWhite];
