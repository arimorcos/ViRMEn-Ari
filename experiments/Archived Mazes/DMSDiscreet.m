function code = DMSDiscreet
% DMSDiscreet   Code for the ViRMEn experiment DMSDiscreet.
%   code = DMSDiscreet   Returns handles to the functions that ViRMEn
...
if vr.inITI == 1
    ...
    if vr.cellWrite
        [dataStruct] = createSaveStruct(vr.mouseNum,vr.experimenter,...
            ...
            vr.startTime,'greyFac',vr.greyFac,'numRewPer',vr.numRewPer); %#ok<NASGU>
