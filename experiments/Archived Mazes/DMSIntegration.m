function code = DMSIntegration
% DMSIntegration   Code for the ViRMEn experiment DMSIntegration.
%   code = DMSIntegration   Returns handles to the functions that ViRMEn
