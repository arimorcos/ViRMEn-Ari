function code = IntNoDelay
% IntNoDelay   Code for the ViRMEn experiment IntNoDelay.
%   code = IntNoDelay   Returns handles to the functions that ViRMEn
...
vr.intGraded = 1; %0 - only 0-8, 1 - up to 1-7, 2- up to 2-6, 3-all

vr.greyFac = 1/11; %goes from 0 to 1 to signify the amount of maze which is grey
vr.numRewPer = 1;
vr.numSeg = 8;
