function code = AMDMSMaze4WallsAdaptiveNoTower4CondBlLeftWhiteRight
% AMDMSMaze4WallsAdaptiveNoTower4CondBlLeftWhiteRight   Code for the ViRMEn experiment AMDMSMaze4WallsAdaptiveNoTower4CondBlLeftWhiteRight.
%   code = AMDMSMaze4WallsAdaptiveNoTower4CondBlLeftWhiteRight   Returns handles to the functions that ViRMEn
...
%         disp(['white:',num2str(vr.percWhiteRightTurn)]);
%         disp(['black:',num2str(vr.percBlackLeftTurn)]);
        vr.randCueTurn = rand;
        vr.randCueColor = rand;
%         disp(['randcuecolor:',num2str(vr.randCueColor)]);
