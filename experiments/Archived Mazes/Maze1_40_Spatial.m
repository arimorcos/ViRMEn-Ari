function code = Maze1_40_Spatial
% Maze1_40_Spatial   Code for the ViRMEn experiment Maze1_40_Spatial.
%   code = Maze1_40_Spatial   Returns handles to the functions that ViRMEn
