function code = ContinuityAlcoveTest
...
for i = 2:2:16
    vr.worlds{1}.surface.visible(vr.LeftWallDelay(1)+ceil((vr.LeftWallDelay(2)-vr.LeftWallDelay(1))*(i-1)*(vr.segLength/500)):...
            vr.LeftWallDelay(1)+floor((vr.LeftWallDelay(2)-vr.LeftWallDelay(1))*i/16)) = 1;
    vr.worlds{1}.surface.visible(vr.RightWallDelay(1)+ceil((vr.RightWallDelay(2)-vr.RightWallDelay(1))*(i-1)*(vr.segLength/500)):...
...
if vr.inITI == 1
    ...
    if vr.itiTime > vr.itiDur
        ...
        for i = 2:2:16
            vr.worlds{1}.surface.visible(vr.LeftWallDelay(1)+ceil((vr.LeftWallDelay(2)-vr.LeftWallDelay(1))*(i-1)/16):...
                    vr.LeftWallDelay(1)+floor((vr.LeftWallDelay(2)-vr.LeftWallDelay(1))*i/16)) = 1;
            vr.worlds{1}.surface.visible(vr.RightWallDelay(1)+ceil((vr.RightWallDelay(2)-vr.RightWallDelay(1))*(i-1)/16):...
                vr.RightWallDelay(1)+floor((vr.RightWallDelay(2)-vr.RightWallDelay(1))*i/16)) = 1;
        end
