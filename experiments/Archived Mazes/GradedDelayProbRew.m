function code = GradedDelayProbRew
% GradedDelayProbRew   Code for the ViRMEn experiment GradedDelayProbRew.
%   code = GradedDelayProbRew   Returns handles to the functions that ViRMEn
...
if vr.inITI == 1
    ...
    if vr.itiTime > vr.itiDur
        ...
        if vr.numTrialsDelayLevel >= vr.trialThresh && vr.percGraded < 60
