function code = Maze5_Spatial_2T
% Maze5_Spatial_2T   Code for the ViRMEn experiment Maze5_Spatial_2T.
%   code = Maze5_Spatial_2T   Returns handles to the functions that ViRMEn
