function code = DMSIntegrationAlcove
% DMSIntegrationAlcove   Code for the ViRMEn experiment DMSIntegrationAlcove.
%   code = DMSIntegrationAlcove   Returns handles to the functions that ViRMEn
...
if vr.cuePos <= 2
    numWhite = randi([0 4],1);
else
    numWhite = randi([4 8],1);
end
