function code = AMDMSMaze1Walls
% AMDMSMaze1Walls   Code for the ViRMEn experiment AMDMSMaze1Walls.
%   code = AMDMSMaze1Walls   Returns handles to the functions that ViRMEn
