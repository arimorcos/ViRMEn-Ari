function code = Maze9_Spatial_Discrete_ExtDelay_Crutch
% Maze9_Spatial_Discrete_ExtDelay_Crutch   Code for the ViRMEn experiment Maze9_Spatial_Discrete_ExtDelay_Crutch.
%   code = Maze9_Spatial_Discrete_ExtDelay_Crutch   Returns handles to the functions that ViRMEn
...
vr.delay = 50; %number of units for delay to start at

%extending delay control
vr.extendDelay = true; %should delay extend?
...
vr.endWallsTowersInd = [vr.worlds{1}.objects.indices.endLeftGrey ...
    ...
    vr.worlds{1}.objects.indices.endTowerRight];
