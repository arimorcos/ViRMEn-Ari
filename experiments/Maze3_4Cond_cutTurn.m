function code = Maze3_4Cond_cutTurn
% Maze3_4Cond_cutTurn   Code for the ViRMEn experiment Maze3_4Cond_cutTurn.
%   code = Maze3_4Cond_cutTurn   Returns handles to the functions that ViRMEn
