function code = Maze3_Spatial_cutTurn
% v   Code for the ViRMEn experiment Maze1_40_Spatial_cutTurn.
%   code = Maze3_Spatial_cutTurn   Returns handles to the functions that ViRMEn
