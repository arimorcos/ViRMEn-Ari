...
vr.condProbs(2,:) = [1/2 1/2 0 0]; %condition probabilities for the up to 1-5 condition. Must add up to 1
vr.condProbs(3,:) = [1/3 1/3 1/3 0]; %condition probabilities for the 2.4 condition. Must add up to 1
vr.condProbs(4,:) = [2/7 2/7 2/7 1/7]; %condition probabilities for the all condition. Must add up to 1
vr.condProbs(5,:) = [0 0 1 0]; %condition probabilities for the all condition. Must add up to 1
vr.intGraded = 4; %0 - only 0-4, 1 - up to 1-3, 2- all
