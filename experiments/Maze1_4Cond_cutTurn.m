function code = Maze1_4Cond_cutTurn
% Maze1_4Cond_cutTurn   Code for the ViRMEn experiment Maze1_4Cond_cutTurn.
%   code = Maze1_4Cond_cutTurn   Returns handles to the functions that ViRMEn
