function code = Maze4_Spatial_cutTurn
% Maze4_Spatial_cutTurn   Code for the ViRMEn experiment Maze4_Spatial_cutTurn.
%   code = Maze4_Spatial_cutTurn   Returns handles to the functions that ViRMEn
