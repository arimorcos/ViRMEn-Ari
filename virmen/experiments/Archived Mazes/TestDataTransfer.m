function code = TestDataTransfer
% AMTMazeTrainingMaze2   Code for the ViRMEn experiment AMTMazeTrainingMaze2.
%   code = AMTMazeTrainingMaze2   Returns handles to the functions that ViRMEn
