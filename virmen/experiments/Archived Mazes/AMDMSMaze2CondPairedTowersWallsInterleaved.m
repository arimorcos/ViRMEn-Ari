function code = AMDMSMaze2CondPairedTowersWallsInterleaved
% AMDMSMaze2CondPairedTowersWallsInterleaved   Code for the ViRMEn experiment AMDMSMaze2CondPairedTowersWallsInterleaved.
%   code = AMDMSMaze2CondPairedTowersWallsInterleaved   Returns handles to the functions that ViRMEn
...
if vr.inITI == 1
    ...
    if vr.itiTime > vr.itiDur
        ...
        vr.randCueLeft = rand;
        vr.randCueBlock = rand;
        if vr.randCueBlock >= .5
...
if vr.shouldUDP
    flushoutput(vr.udp);
    fwrite(vr.udp,[double(datestr(now - vr.startTime,'HH:MM:SS')) vr.numTrialsTower vr.numRewardsTower...
        100*vr.numRewardsTower/vr.numTrialsTower vr.numTrialsNoTower vr.numRewardsNoTower...
        100*vr.numRewardsNoTower/vr.numTrialsNoTower vr.turnOffUDP]);
end
