function code = AMDMSMaze4WallsAdaptiveTower2Cond
% AMDMSMaze4WallsAdaptiveTower2Cond   Code for the ViRMEn experiment AMDMSMaze4WallsAdaptiveTower2Cond.
%   code = AMDMSMaze4WallsAdaptiveTower2Cond   Returns handles to the functions that ViRMEn
