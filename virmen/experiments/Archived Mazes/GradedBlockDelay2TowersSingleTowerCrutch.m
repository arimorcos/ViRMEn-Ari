function code = GradedBlockDelay2TowersSingleTowerCrutch
% GradedBlockDelay2TowersSingleTowerCrutch   Code for the ViRMEn experiment GradedBlockDelay2TowersSingleTowerCrutch.
%   code = GradedBlockDelay2TowersSingleTowerCrutch   Returns handles to the functions that ViRMEn
...
vr.crutchAdaptive = false; %boolean of whether crutches should be adaptive 
...
vr.blackLeftCrutch = [beginBlack vr.whiteRight backBlack vr.blackLeftTower(1):vr.blackLeftTower(2)];
vr.blackRightCrutch = [beginBlack vr.whiteLeft backBlack vr.blackRightTower(1):vr.blackRightTower(2)];
vr.whiteLeftCrutch = [beginWhite vr.whiteLeft backWhite vr.whiteLeftTower(1):vr.whiteLeftTower(2)];
vr.whiteRightCrutch = [beginWhite vr.whiteRight backWhite vr.whiteRightTower(1):vr.whiteRightTower(2)];
