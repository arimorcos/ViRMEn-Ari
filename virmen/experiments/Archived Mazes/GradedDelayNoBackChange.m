function code = GradedDelayNoBackChange
% GradedDelayNoBackChange   Code for the ViRMEn experiment GradedDelayNoBackChange.
%   code = GradedDelayNoBackChange   Returns handles to the functions that ViRMEn
...
if vr.inITI == 1
    ...
    if vr.itiTime > vr.itiDur
        ...
        if vr.numTrialsDelayLevel >= vr.trialThresh && vr.percGraded < 25
