function code = testStutter
% testStutter   Code for the ViRMEn experiment testStutter.
%   code = testStutter   Returns handles to the functions that ViRMEn
