function code = AMDMSMaze3WallsAdaptiveNoTower
% AMDMSMaze3WallsAdaptiveNoTower   Code for the ViRMEn experiment AMDMSMaze3WallsAdaptiveNoTower.
%   code = AMDMSMaze3WallsAdaptiveNoTower   Returns handles to the functions that ViRMEn
