function code = SingleTower4Cond_cutTurn
% SingleTower4Cond_cutTurn   Code for the ViRMEn experiment SingleTower4Cond_cutTurn.
%   code = SingleTower4Cond_cutTurn   Returns handles to the functions that ViRMEn
