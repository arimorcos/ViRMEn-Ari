function code = GradedBlockDelay2TowersContCrutch_450
% GradedBlockDelay2TowersContCrutch_450   Code for the ViRMEn experiment GradedBlockDelay2TowersContCrutch_450.
%   code = GradedBlockDelay2TowersContCrutch_450   Returns handles to the functions that ViRMEn
...
vr.mouseNum = 110;
vr.greyFac = 5/45; %goes from 0 to 1 to signify the amount of maze which is grey
vr.midOff = 40/45;
vr.numRewPer = 1;
...
%blocks
vr.blockThresh = [0 1/9 2/9 3/9]; %thresholds for blocks
vr.trialBlockThresh = 10;
vr.percBlockThresh = 0.75;
vr.roundVec = 0:(1/45):1;

%delay advance
vr.advCount = 2; %net count value to advance
vr.regCount = -2; %net count value to regress
vr.advRate = 1/45; %must be related to number of textures
vr.regRate = 1/45;
vr.maxGrey = 1/3;
