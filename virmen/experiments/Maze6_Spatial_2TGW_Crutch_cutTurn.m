function code = Maze6_Spatial_2TGW_Crutch_cutTurn
% Maze6_Spatial_2TGW_Crutch_cutTurn   Code for the ViRMEn experiment Maze6_Spatial_2TGW_Crutch_cutTurn.
%   code = Maze6_Spatial_2TGW_Crutch_cutTurn   Returns handles to the functions that ViRMEn
...
vr.crutchIdentity = 'DotWallsTowerGrey'; %identity of crutch trial
...
vr.dotsLeft = [vr.leftDots(1):vr.leftDots(2) vr.rightGrey(1):vr.rightGrey(2) ...
    ...
    vr.endTowerRight(1):vr.endTowerRight(2)];
vr.dotsRight = [vr.rightDots(1):vr.rightDots(2) vr.leftGrey(1):vr.leftGrey(2) ...
    ...
    vr.endTowerLeft(1):vr.endTowerLeft(2)];
...
if vr.inITI == 1
    ...
    if vr.cellWrite
        [dataStruct] = createSaveStruct(vr.mouseNum,vr.experimenter,...
            ...
            'crutchIdentity',vr.crutchIdentity); %#ok<NASGU>
