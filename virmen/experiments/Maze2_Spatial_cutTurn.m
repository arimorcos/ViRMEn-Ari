function code = Maze2_Spatial_cutTurn
% Maze2_Spatial_cutTurn   Code for the ViRMEn experiment Maze2_Spatial_cutTurn.
%   code = Maze2_Spatial_cutTurn   Returns handles to the functions that ViRMEn
