function code = Maze7b_Spatial_FixedDelay50_cutTurn
% Maze7b_Spatial_FixedDelay50_cutTurn   Code for the ViRMEn experiment Maze7b_Spatial_FixedDelay50_cutTurn.
%   code = Maze7b_Spatial_FixedDelay50_cutTurn   Returns handles to the functions that ViRMEn
...
vr.delay = 30; %number of units for delay to start at
...
vr.minDelay = 30; %minimum delay (in units);
...
vr.dotsRight = [(vr.rightDots(1):vr.rightDots(1) + floor(...
    ...
    vr.endRightGrey(1):vr.endRightGrey(2) vr.endTowerLeft(1):vr.endTowerLeft(2),...
    vr.endTowerRight(1):vr.endTowerRight(2) vr.behindWalls(1):vr.behindWalls(2)...
    vr.leftGrey(1):vr.leftGrey(2) vr.leftCutWall(1):vr.leftCutWall(2) ...
    vr.rightCutWall(1):vr.rightCutWall(2)];
